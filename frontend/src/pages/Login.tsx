...
import { User, Lock, Eye, EyeOff, MessageSquare, Smartphone, ArrowLeft, Sparkles, Download } from 'lucide-react'
          ...
          >
            ...
            {!isInstalled && (
              <motion.div className="mt-4 text-center" variants={itemVariants}>
                {isIOS ? (
                  <button onClick={() => setIosGuideOpen(true)}
                    className="inline-flex items-center gap-1.5 text-xs font-semibold text-amber-500 hover:text-amber-600 transition-colors bg-transparent border-none cursor-pointer">
                    <Download size={14} />
