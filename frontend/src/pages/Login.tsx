...
import { User, Lock, Eye, EyeOff, MessageSquare, ArrowLeft, Sparkles } from 'lucide-react'
...
export default function Login() {
  ...
  const [twoFactor, setTwoFactor] = useState<{ requires_2fa: boolean; phone: string } | null>(null)
        ...
        >
          <div className="bg-white/90 backdrop-blur-2xl rounded-3xl px-10 py-12 border border-white/50 shadow-xl shadow-brand-500/5">
            ...
            >
              ...
              <p className="text-sm text-slate-400 mt-2">کد تایید به شماره {twoFactor.phone} ارسال شد</p>
            </motion.div>
