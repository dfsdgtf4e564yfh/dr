  ...
  return (
    <div className="space-y-5">
      ...
      {loading ? (
        ...
        <div className="panel card-iranian">
          <div className="table-wrap">
            <table>
              <thead><tr>
                <th className="text-center">نام نقش</th>
                <th className="text-center">توضیحات</th>
                <th className="text-center">تعداد دسترسی‌ها</th>
              ...
              <tbody>
                {roles.map(r => (
                  <tr key={r.id}>
                    ...
                    <td className="text-center text-slate-500 text-sm max-w-xs truncate">{r.description || '—'}</td>
                    <td className="text-center">{getPermissionCount(r.permissions)}</td>
      ...
      {showModal && createPortal(
        <div className="fixed inset-0 bg-black/30 z-[100] flex items-start justify-center p-4 overflow-y-auto">
