              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50/50">
                    <th className="text-center px-4 py-3 text-xs font-bold text-slate-500 whitespace-nowrap">تاریخ</th>
                    <th className="text-center px-4 py-3 text-xs font-bold text-slate-500 whitespace-nowrap">گیرنده</th>
                    <th className="text-center px-4 py-3 text-xs font-bold text-slate-500 whitespace-nowrap">شماره</th>
                    <th className="text-center px-4 py-3 text-xs font-bold text-slate-500 whitespace-nowrap">نوع</th>
                    <th className="text-center px-4 py-3 text-xs font-bold text-slate-500 whitespace-nowrap">متن</th>
                    <th className="text-center px-4 py-3 text-xs font-bold text-slate-500 whitespace-nowrap">روش</th>
                    <th className="text-center px-4 py-3 text-xs font-bold text-slate-500 whitespace-nowrap">ارسال‌کننده</th>
                    <th className="text-center px-4 py-3 text-xs font-bold text-slate-500 whitespace-nowrap">IP</th>
                    <th className="text-center px-4 py-3 text-xs font-bold text-slate-500 whitespace-nowrap">وضعیت</th>
                    <th className="text-center px-4 py-3 text-xs font-bold text-slate-500 whitespace-nowrap">شناسه</th>
                  </tr>
                </thead>
                <tbody>
                  {logs.map(log => {
