    ...
    <div class="section">
      ...
      <div class="section-body">
        <div style="display:flex;flex-wrap:wrap;gap:8px;">
          ...
          <div style="flex:1;min-width:60px;text-align:center;padding:4px 6px;background:#f8fafc;border:1px solid #e2e8f0;"><div style="font-weight:700;color:#1e3a5f;font-size:8px;">U</div><div style="font-size:10px;font-weight:700;margin-top:2px;">${d.score_u || '—'}</div></div>
          ...
          <div style="flex:1;min-width:60px;text-align:center;padding:4px 6px;background:#f8fafc;border:1px solid #e2e8f0;"><div style="font-weight:700;color:#1e3a5f;font-size:8px;">Mt</div><div style="font-size:10px;font-weight:700;margin-top:2px;">${d.score_mt1 || '—'}</div></div>
          <div style="flex:1;min-width:60px;text-align:center;padding:4px 6px;background:#f8fafc;border:1px solid #e2e8f0;"><div style="font-weight:700;color:#1e3a5f;font-size:8px;">Mt</div><div style="font-size:10px;font-weight:700;margin-top:2px;">${d.score_mt2 || '—'}</div></div>
          <div style="flex:1;min-width:60px;text-align:center;padding:4px 6px;background:#f8fafc;border:1px solid #e2e8f0;"><div style="font-weight:700;color:#1e3a5f;font-size:8px;">Mt</div><div style="font-size:10px;font-weight:700;margin-top:2px;">${d.score_mt3 || '—'}</div></div>
          <div style="flex:1;min-width:60px;text-align:center;padding:4px 6px;background:#f8fafc;border:1px solid #e2e8f0;"><div style="font-weight:700;color:#1e3a5f;font-size:8px;">Mt</div><div style="font-size:10px;font-weight:700;margin-top:2px;">${d.score_mt4 || '—'}</div></div>
        </div>
      </div>
    </div>
  ...
  const openEdit = async (id: number) => {
    try {
      ...
      setFormData({
        ...
        score_u: form.score_u?.toString() || '',
        score_y: form.score_y?.toString() || '',
        score_mt1: form.score_mt1?.toString() || '',
        score_mt2: form.score_mt2?.toString() || '',
        score_mt3: form.score_mt3?.toString() || '',
        score_mt4: form.score_mt4?.toString() || '',
          ...
          <div className="card">
            ...
            <div className="panel-body">
              <div className="grid grid-cols-3 md:grid-cols-5 gap-4">
                ...
                <div><label className="label">U</label><input className="input-field" type="number" step="any" value={formData.score_u} onChange={e => updateField('score_u', e.target.value)} /></div>
                ...
                <div><label className="label">Mt</label><input className="input-field" type="number" step="any" value={formData.score_mt1} onChange={e => updateField('score_mt1', e.target.value)} /></div>
                <div><label className="label">Mt</label><input className="input-field" type="number" step="any" value={formData.score_mt2} onChange={e => updateField('score_mt2', e.target.value)} /></div>
                <div><label className="label">Mt</label><input className="input-field" type="number" step="any" value={formData.score_mt3} onChange={e => updateField('score_mt3', e.target.value)} /></div>
                <div><label className="label">Mt</label><input className="input-field" type="number" step="any" value={formData.score_mt4} onChange={e => updateField('score_mt4', e.target.value)} /></div>
              </div>
            </div>
          </div>
