...
function generatePrintHtml(data: Record<string, any>, patientInfo: Record<string, any> | null) {
  ...
  <div class="page">
    ...
    <div class="form-meta">
      <div class="code-badge">کد خدمت: ${toPersianDigits(d.service_code || '900115')}</div>
    ...
    <div class="patient-box">
      ...
      <div class="item"><span class="lbl">شماره پرونده:</span><span class="val">${p.file_number ? toPersianDigits(p.file_number) : '—'}</span></div>
      <div class="item"><span class="lbl">سن:</span><span class="val">${p.age ? toPersianDigits(p.age) : '—'}</span></div>
      ...
      <div class="item"><span class="lbl">شغل:</span><span class="val">${p.job || '—'}</span></div>
...
export default function TmsForms() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('متأسفانه در ذخیره فرم TMS خطایی رخ داد ')
    } finally {
      setSaving(false)
    }
  }
    ...
    return (
      <div className="max-w-5xl mx-auto space-y-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="card">
            <div className="panel-header"><h3>اطلاعات فرم</h3></div>
            <div className="panel-body">
              ...
              {patientInfo && (
                <div className="mt-3 p-3 bg-slate-50 rounded-lg grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
                  ...
                  <div><span className="text-gray-500">شماره پرونده:</span> <span className="font-medium">{patientInfo.file_number ? toPersianDigits(patientInfo.file_number) : '—'}</span></div>
                  <div><span className="text-gray-500">سن:</span> <span className="font-medium">{patientInfo.age ? toPersianDigits(patientInfo.age) : '—'}</span></div>
                  <div><span className="text-gray-500">شماره تماس:</span> <span className="font-medium ltr">{toPersianDigits(patientInfo.phone)}</span></div>
                  ...
                  <div className="col-span-2"><span className="text-gray-500">شغل:</span> <span className="font-medium">{patientInfo.job || '—'}</span></div>
          ...
          <div className="card">
            <div className="panel-header"><h3>علائم جاری بیمار</h3></div>
            <div className="panel-body">
          ...
          <div className="card">
            <div className="panel-header"><h3>سوابق درمانی</h3></div>
            <div className="panel-body">
          ...
          <div className="card">
            <div className="panel-header"><h3>داروهای مورد استفاده فعلی</h3></div>
            <div className="panel-body">
          ...
          <div className="card">
            <div className="panel-header"><h3>موارد استفاده از TMS و یافته‌های QEEG</h3></div>
            <div className="panel-body">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="card">
            <div className="panel-header"><h3>پروتکل درمانی</h3></div>
            <div className="panel-body">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="card">
            <div className="panel-header"><h3>جلسات درمان</h3></div>
            <div className="panel-body">
          ...
          <div className="card">
            <div className="panel-header"><h3>رضایت‌نامه</h3></div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b text-gray-600">
                ...
                <th className="text-right py-3 px-2">بیمار</th>
                <th className="text-right py-3 px-2">تاریخ</th>
                <th className="text-right py-3 px-2">پزشک</th>
