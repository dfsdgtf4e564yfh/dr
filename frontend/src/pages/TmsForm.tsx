            ...
            <div className="panel-body">
              ...
              {patientInfo && (
                <div className="mt-3 p-3 bg-slate-50 rounded-lg grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
                  ...
                  <div><span className="text-gray-500">پرونده قدیمی:</span> <span className="font-medium">{patientInfo.old_file_number ? smartPersianDigits(patientInfo.old_file_number) : '—'}</span></div>
