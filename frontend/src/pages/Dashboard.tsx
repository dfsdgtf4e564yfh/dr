            ...
            <div className="card p-6 h-full flex flex-col">
              <div className="flex-1 flex flex-col items-center justify-center">
                ...
                <div className="flex gap-2 flex-wrap justify-center">
                  {hasRole('admin') && (
                    <>
                      <button onClick={() => navigate('/panel/users')} className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold bg-brand-500 text-white hover:bg-brand-600 transition-all shadow-sm">
                        <UserPlus size={14} /> کاربران
                      </button>
                      <button onClick={() => navigate('/panel/settings')} className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold border-2 border-surface-200 text-surface-600 hover:border-brand-500 hover:text-brand-500 transition-all">
