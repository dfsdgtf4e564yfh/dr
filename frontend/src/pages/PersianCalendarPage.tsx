...
import { toPersianDigits, toJalali, getPersianMonthName, PERSIAN_MONTHS } from '../utils/jalali'
    ...
    <div className="space-y-6">
      <PageHeader title="تقویم شمسی">
        {hasPermission('appointments') && (
          <Button onClick={() => navigate('/appointments')} variant="primary" icon={List}>مدیریت نوبت‌ها</Button>
        )}
      </PageHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="card p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              {selectedDate && (
                <button onClick={() => navigate(`/appointments?date=${selectedDate}`)} className="text-xs text-brand-500 hover:text-brand-600">
