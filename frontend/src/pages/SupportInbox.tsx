...
import { MessageSquare, Send, CheckCircle, Clock, Plus, X, Search } from 'lucide-react'
import { getSupportMessages, createSupportMessage, replySupportMessage, searchPatients } from '../services/api'
...
export default function SupportInbox() {
  ...
  const [newMessage, setNewMessage] = useState({ patient: '', patient_name: '', subject: '', message: '' })
  const { user } = useAuth()
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setShowModal(false)
      setNewMessage({ patient: '', patient_name: '', subject: '', message: '' })
      loadMessages()
