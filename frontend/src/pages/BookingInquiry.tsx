...
import { toEnglishDigits, toJalaliNumeric, nowJalali, toPersianDigits, smartPersianDigits } from '../utils/jalali'
                ...
                <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 p-5 border border-gray-100">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      {data.patient.file_number && <p className="text-xs text-gray-400">شماره پرونده: {smartPersianDigits(data.patient.file_number)}</p>}
                    </div>
                  </div>
                </div>
              )}
