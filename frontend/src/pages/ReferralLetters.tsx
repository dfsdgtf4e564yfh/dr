...
import { toJalali, toPersianDigits, smartPersianDigits, mediaUrl } from '../utils/jalali'
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          {hasPermission('referral_letter_create') && (
            ...
            <div key={l.id} className="card">
              <div className="flex justify-between items-start">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {hasPermission('referral_letters') && (
            ...
            <div className="flex-1 overflow-y-auto p-6" ref={printRef}>
              ...
              <div className="ref-sig text-center mt-6 pt-3 border-t border-dashed border-slate-200">
                ...
                {printData.from_doctor_signature ? (
                  <img src={mediaUrl(printData.from_doctor_signature)} alt="امضا" className="sig-img max-h-[40px] max-w-[120px] object-contain" />
                ) : (
