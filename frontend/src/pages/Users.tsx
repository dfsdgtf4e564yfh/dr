...
import { getUsers, createUser, updateUser, deleteUser, getAvailablePermissions, getRoles, getDoctors, getTreatmentTypes, setUserRestrictions } from '../services/api'
...
export default function Users() {
  ...
  const openEdit = (u: User) => {
    ...
    setForm({
      ...
      restrictions: userData.restrictions || { doctor_ids: [], treatment_ids: [] },
    })
    setShowModal(true)
  }
