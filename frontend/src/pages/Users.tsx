...
const roleLabels: Record<string, string> = { admin: 'مدیر کلینیک', reception: 'پذیرش', doctor: 'درمانگر', psychologist: 'روانشناس / درمانگر', rtms: 'کاربر ویژه', support: 'پشتیبانی' }
            ...
            {users.map(u => (
              <div key={u.id} className="table-card-item">
                ...
                <div className="table-card-row">
                  ...
                  <span className="table-card-value">{u.first_name} {u.last_name}</span>
                </div>
                <div className="table-card-row">
                  <span className="table-card-label">نقش</span>
                  <span className="table-card-value">{roleLabels[u.role] || u.role}</span>
                </div>
                <div className="table-card-row">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div><label className="label">نقش</label>
                    <select className="input-field" value={form.role} onChange={e => handleRoleChange(e.target.value)}>
                      <option value="reception">پذیرش</option><option value="doctor">درمانگر</option><option value="psychologist">روانشناس / درمانگر</option><option value="rtms">کاربر ویژه</option><option value="admin">مدیر کلینیک</option>
                    </select>
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
