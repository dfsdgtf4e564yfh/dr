                   ...
                   {patients.map((p: any, idx: number) => (
                     <tr key={p.id}>
                       <td className="text-center font-bold text-surface-400">{toPersianDigits(idx + 1)}</td>
                        <td className="text-center font-medium">{p.first_name}</td>
                        <td className="text-center font-medium">{p.last_name}</td>
                        <td className="text-center">{p.father_name || '—'}</td>
                        <td className="text-center">{toPersianDigits(p.national_id)}</td>
                         <td className="text-center">{toPersianDigits(p.phone)}</td>
                         <td className="text-center font-bold text-brand-500">{toPersianDigits(p.file_number || p.id)}</td>
