...
export default function Patients() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      else { await createPatient(payload); toast.success(`بیمار ${form.first_name} ${form.last_name} با موفقیت به سیستم اضافه شد`, { icon: <CheckCircle size={20} /> }) }
  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        <div className="panel"><SkeletonTable rows={8} cols={8} /></div>
      ) : patients.length === 0 ? (
