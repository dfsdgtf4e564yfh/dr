              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-200">
                    <th className="text-right py-3 px-2 font-semibold text-slate-600">ردیف</th>
                    <th className="text-right py-3 px-2 font-semibold text-slate-600">تاریخ</th>
                    <th className="text-right py-3 px-2 font-semibold text-slate-600">دلیل</th>
                    <th className="text-right py-3 px-2 font-semibold text-slate-600">وضعیت</th>
                    <th className="text-left py-3 px-2 font-semibold text-slate-600">عملیات</th>
                  </tr>
                </thead>
                <tbody>
                  {holidays.map((h, i) => (
