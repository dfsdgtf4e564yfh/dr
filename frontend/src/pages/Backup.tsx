...
import { Download, Trash2, RefreshCw, Database, FileDown, Upload, FileSpreadsheet, Mail, CheckCircle, XCircle, Save, Settings, Github, Globe, UploadCloud, Image, Archive } from 'lucide-react'
import { getBackups, createBackup, downloadDatabase, fullExportBackup, downloadBackup, deleteBackup, restoreBackup, exportPatientsCsv, exportAppointmentsCsv, exportMedicalRecordsCsv, exportBillingsCsv, importPatientsExcel, getEmailConfig, updateEmailConfig, testEmailConnection, sendBackupViaEmail, getGitHubConfig, updateGitHubConfig, testGitHubConnection, uploadBackupToGitHub } from '../services/api'
        ...
        <>
          <div className="panel card-iranian">
            ...
            <div className="panel-body">
              <p className="text-sm text-slate-500 mb-3">فایل پشتیبان (.zip از پشتیبان کامل، .db یا .sqlite3) را انتخاب کنید. تمام داده‌های فعلی پاک شده و با داده‌های فایل جایگزین می‌شوند.</p>
