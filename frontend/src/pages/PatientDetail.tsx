  ...
  <div class="footer">
    <div class="footer-grid">
      <div>
        ...
        <div><span class="lbl">تلفن تماس:</span> ${toPersianDigits(clinicPhone)}${clinicPhone2 ? ` / ${toPersianDigits(clinicPhone2)}` : ''}</div>
      </div>
  ...
  <div class="footer">
    <div class="footer-inner">
      <div>
        ...
        ${clinicSettings?.phone ? `<span> — تلفن: ${toPersianDigits(clinicSettings.phone)}</span>` : ''}
      </div>
