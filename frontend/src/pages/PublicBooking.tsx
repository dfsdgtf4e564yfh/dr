...
const DR_INFO = {
  ...
  description: 'دکتر محمد طاهری از بهترین متخصصان اعصاب و روان و روانپزشک در بندرعباس می‌باشند. ایشان دارای ۱۵ سال سابقه فعالیت بعنوان روانپزشک (متخصص اعصاب و روان) در بندرعباس و بیمارستان‌های مختلف و سابقه عضویت در کمیسیون‌های پزشکی نیز هستند.',
  longBio: `دکتر محمد طاهری متخصص اعصاب و روان (روانپزشک)، دارای ۱۵ سال سابقه فعالیت در بندرعباس و بیمارستان‌های مختلف می‌باشند.
...
export default function PublicBooking() {
  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center pt-16 pb-24">
            <div className={`space-y-6 transition-all duration-700 delay-200 ${heroLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
              ...
              <div className="flex flex-wrap gap-6 pt-2">
                {[
                  { icon: <Award size={16} />, label: 'بیش از ۱۵ سال سابقه' },
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-4 bg-gray-50 rounded-2xl p-6 border border-gray-100">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs font-bold text-gray-800">۱۵ سال سابقه فعالیت</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-50 rounded-3xl p-6 border border-gray-100 text-center hover:shadow-lg transition-all">
              ...
              <p className="text-xs text-gray-500 ltr" dir="ltr">{DR_INFO.phone2} - {DR_INFO.phone1}</p>
            </div>
            <div className="bg-gray-50 rounded-3xl p-6 border border-gray-100 text-center hover:shadow-lg transition-all">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#2ab3b8]/10 to-[#1a4a8a]/10 mx-auto mb-4 flex items-center justify-center">
          ...
          <div className="mt-8 bg-gradient-to-br from-[#1a4a8a]/5 to-[#2ab3b8]/5 rounded-3xl p-6 border border-[#1a4a8a]/10 text-center">
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <a href={`tel:${DR_INFO.phone1}`} className="flex items-center gap-2 text-sm text-gray-600 hover:text-[#1a4a8a] transition-colors">
                <Phone size={14} className="text-[#2ab3b8]" /> {DR_INFO.phone1}
              </a>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-3 text-xs text-white/50">
                ...
                <p className="flex items-center gap-2 ltr" dir="ltr"><Phone size={12} className="shrink-0 text-[#67e8f9]" />{DR_INFO.phone1}</p>
      ...
      {/* ===== INQUIRY MODAL ===== */}
      {inquiryModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4" onClick={() => { setInquiryModalOpen(false); setInquiryCodeInput('') }}>
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-6 animate-fade-in-up" onClick={e => e.stopPropagation()}>
            <div className="text-center mb-6">
              ...
              <p className="text-xs text-gray-400 mt-1">کد ملی خود را وارد کنید</p>
            </div>
            <input className="input-field text-center text-lg font-bold tracking-[0.3em] w-full mb-4" placeholder="کد ملی ۱۰ رقمی" value={inquiryCodeInput} onChange={e => setInquiryCodeInput(e.target.value.replace(/\D/g, '').slice(0, 10))} maxLength={10} inputMode="numeric" autoFocus onKeyDown={e => { if (e.key === 'Enter' && inquiryCodeInput.length === 10) { setInquiryModalOpen(false); window.location.href = '/booking-inquiry/' + inquiryCodeInput } }} />
            <div className="flex gap-3">
              <button onClick={() => { setInquiryModalOpen(false); setInquiryCodeInput('') }} className="flex-1 py-3 bg-gray-100 text-gray-600 rounded-2xl font-medium text-sm hover:bg-gray-200 transition-all">انصراف</button>
              <button onClick={() => { if (inquiryCodeInput.length !== 10) { toast.error('کد ملی باید ۱۰ رقم باشد'); return }; setInquiryModalOpen(false); window.location.href = '/booking-inquiry/' + inquiryCodeInput }} disabled={inquiryCodeInput.length !== 10}
              ...
              {modalStep === 'exists' && patientData && (
                <>
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-4 border border-green-100 text-center">
                    ...
                    {patientData.file_number && <p className="text-xs text-gray-500 mt-1">شماره پرونده: {patientData.file_number}</p>}
                  </div>
                ...
                <div className="border-t border-gray-100 pt-4 space-y-4">
                    <>
                      <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-4 border border-gray-100 space-y-2 text-xs">
                        ...
                        <p className="flex justify-between"><span className="text-gray-400">ساعت</span><span className="font-semibold text-gray-700">{selectedTime}</span></p>
                      </div>
                      <div>
