...
import type {
  ...
  ClinicSettings, BackupItem, BackupSchedule, EmailConfig,
  PaginatedResponse, AppConfig, Role, PatientTag,
...
export const createSupportMessage = (data: Partial<SupportMessage>) => api.post<SupportMessage>('/patients/support-messages/', data)
