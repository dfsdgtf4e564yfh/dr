...
import {
  ...
  MessageSquare, History, Inbox, Archive, Command, Sparkles, Clock, Download
} from 'lucide-react'
  ...
  return (
    <div className="flex h-screen bg-slate-50">
      <div className={`fixed inset-0 bg-black/20 backdrop-blur-sm z-40 lg:hidden ${sidebarOpen ? '' : 'hidden'}`}
        ...
        <aside className={`sidebar ${sidebarOpen ? 'translate-x-0' : 'translate-x-full'} lg:translate-x-0 lg:static lg:z-auto`}>
      ...
      <div className="flex-1 overflow-y-auto">
        <header className="topbar">
          ...
          <div className="topbar-left">
            ...
            <div ref={bellRef} className="relative">
              ...
              {notifOpen && (
                <div className="absolute left-0 top-full mt-2 w-72 bg-white border border-slate-200 rounded-xl shadow-lg z-50 overflow-hidden">
        ...
        <div className="content p-4 md:p-6 lg:p-8 max-w-7xl mx-auto w-full">
