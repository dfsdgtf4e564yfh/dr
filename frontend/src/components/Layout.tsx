...
const menuGroups: MenuGroup[] = [
  {
    ...
    items: [
      ...
      { to: '/panel/calendar', label: 'تقویم شمسی', icon: Calendar, permission: 'calendar_view' },
    ],
  },
  {
    ...
    items: [
      ...
      { to: '/panel/visit-templates', label: 'قالب‌های ویزیت', icon: FileText, permission: 'medical_record_templates' },
  ...
  },
   {
     ...
     items: [
       ...
       { to: '/panel/users', label: 'کاربران', icon: UserCircle, permission: 'users' },
        ...
        { to: '/panel/holidays', label: 'تعطیلات', icon: Calendar, permission: 'settings' },
     ],
   },
]
