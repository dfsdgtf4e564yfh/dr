    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center"
      ...
      <div className="relative w-full h-full flex flex-col max-w-6xl mx-auto p-4">
        <div className="flex items-center justify-between mb-3 shrink-0" dir="rtl">
          ...
          <a href={mediaUrl(current?.file)} target="_blank" rel="noreferrer"
        ...
        <div className="flex-1 flex items-center justify-center relative min-h-0">
          ...
          <div className="w-full h-full flex items-center justify-center">
            {isImage ? (
              <img src={mediaUrl(current.file)} alt={current.description || ''}
                className="max-w-full max-h-full object-contain rounded-lg"
                style={{ maxHeight: 'calc(100vh - 120px)' }} />
            ) : isPDF ? (
              <iframe src={mediaUrl(current.file)} title={current.description || 'PDF'}
