...
const variantStyles: Record<ButtonVariant, string> = {
  primary: 'bg-brand-500 text-white hover:bg-brand-600 shadow-sm shadow-brand-500/20 hover:shadow-md hover:shadow-brand-500/30',
  ...
  gradient: 'bg-gradient-to-r from-brand-500 to-brand-600 text-white shadow-sm shadow-brand-500/20 hover:shadow-lg hover:shadow-brand-500/30 hover:from-brand-600 hover:to-brand-700',
