...
const sizeStyles: Record<ButtonSize, string> = {
  xs: 'px-2.5 py-1 text-[11px] rounded-lg gap-1 min-h-[36px]',
  sm: 'px-3.5 py-1.5 text-xs rounded-xl gap-1.5 min-h-[40px]',
  md: 'px-5 py-2.5 text-sm rounded-xl gap-2 min-h-[44px]',
  lg: 'px-7 py-3 text-base rounded-xl gap-2.5 min-h-[48px]',
  xl: 'px-9 py-4 text-lg rounded-2xl gap-3 min-h-[52px]',
}
