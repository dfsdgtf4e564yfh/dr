...
import { X, User, Camera, Save, Lock } from 'lucide-react'
    ...
    <Modal open={open} onClose={onClose} size="sm">
      <div className="text-center mb-6">
        <div className="relative w-20 h-20 rounded-full mx-auto mb-4">
          {user?.avatar ? (
            <img src={user.avatar} alt="" className="w-20 h-20 rounded-full object-cover shadow-md shadow-brand-500/20" />
          ) : (
      ...
      <form onSubmit={handlePasswordChange} className="space-y-4">
        ...
        <div>
          ...
          <input className="input-field ltr" dir="ltr" type="password" placeholder="••••••"
            value={passwordForm.old_password}
            onChange={e => setPasswordForm({ ...passwordForm, old_password: e.target.value })} />
        </div>
        <div>
          <label className="label">رمز جدید</label>
          <input className="input-field ltr" dir="ltr" type="password" placeholder="حداقل ۶ کاراکتر"
            value={passwordForm.new_password}
            onChange={e => setPasswordForm({ ...passwordForm, new_password: e.target.value })} />
        </div>
        <div>
          <label className="label">تکرار رمز جدید</label>
          <input className="input-field ltr" dir="ltr" type="password" placeholder="تکرار رمز جدید"
