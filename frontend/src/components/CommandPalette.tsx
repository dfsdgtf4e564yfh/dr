...
const navItems: NavSearchItem[] = [
  ...
  { to: '/panel/appointments/report', label: 'گزارش نوبت‌ها', icon: 'FileBarChart', keywords: 'report appointments', category: 'نوبت‌ها' },
  { to: '/panel/medical-records', label: 'پرونده پزشکی', icon: 'FileText', keywords: 'medical records پرونده', category: 'پزشکی' },
  { to: '/panel/doctor-finance', label: 'حساب پزشکان', icon: 'HandCoins', keywords: 'doctor finance حساب', category: 'پزشکی' },
  { to: '/panel/referral-letters', label: 'نامه‌های ارجاع', icon: 'Send', keywords: 'referral letter ارجاع', category: 'پزشکی' },
  { to: '/panel/diagnosis-report', label: 'گزارش تشخیص', icon: 'Activity', keywords: 'diagnosis report تشخیص', category: 'پزشکی' },
  { to: '/panel/diagnosis-drugs', label: 'تشخیص و دارو', icon: 'FileText', keywords: 'diagnosis drugs دارو', category: 'پزشکی' },
  { to: '/panel/tms-forms', label: 'فرم TMS', icon: 'Activity', keywords: 'tms فرم', category: 'فرم‌ها' },
  { to: '/panel/billing', label: 'صورتحساب', icon: 'DollarSign', keywords: 'billing صورتحساب', category: 'مالی' },
  { to: '/panel/billing/report', label: 'گزارش مالی', icon: 'FileBarChart', keywords: 'financial report مالی', category: 'مالی' },
  ...
  { to: '/panel/activity-log', label: 'گزارش رویدادها', icon: 'Activity', keywords: 'activity log رویداد', category: 'مدیریت سیستم' },
