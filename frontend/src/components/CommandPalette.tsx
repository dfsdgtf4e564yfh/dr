...
const navItems: NavSearchItem[] = [
  { to: '/panel/dashboard', label: 'داشبورد', icon: 'LayoutDashboard', keywords: 'main home dashboard', category: 'صفحات اصلی' },
  { to: '/panel/patients', label: 'بیماران', icon: 'Users', keywords: 'patients client مراجع', category: 'صفحات اصلی' },
  { to: '/panel/appointments', label: 'نوبت‌ها', icon: 'Calendar', keywords: 'appointment visit ویزیت', category: 'نوبت‌ها' },
  { to: '/panel/appointments/calendar', label: 'تقویم نوبت‌ها', icon: 'Calendar', keywords: 'calendar تقویم', category: 'نوبت‌ها' },
  { to: '/panel/waiting-list', label: 'لیست انتظار', icon: 'Clock', keywords: 'waiting queue صف', category: 'نوبت‌ها' },
  { to: '/panel/appointments/report', label: 'گزارش نوبت‌ها', icon: 'FileBarChart', keywords: 'report appointments', category: 'گزارش‌ها' },
  { to: '/panel/medical-records', label: 'پرونده پزشکی', icon: 'FileText', keywords: 'medical records پرونده', category: 'پزشکی' },
  { to: '/panel/doctor-finance', label: 'حساب پزشکان', icon: 'HandCoins', keywords: 'doctor finance حساب', category: 'کلینیک' },
  { to: '/panel/referral-letters', label: 'نامه‌های ارجاع', icon: 'Send', keywords: 'referral letter ارجاع', category: 'کلینیک' },
  { to: '/panel/diagnosis-report', label: 'گزارش تشخیص', icon: 'Activity', keywords: 'diagnosis report تشخیص', category: 'گزارش‌ها' },
  { to: '/panel/diagnosis-drugs', label: 'تشخیص و دارو', icon: 'FileText', keywords: 'diagnosis drugs دارو', category: 'کلینیک' },
  { to: '/panel/tms-forms', label: 'فرم TMS', icon: 'Activity', keywords: 'tms فرم', category: 'پزشکی' },
  { to: '/panel/billing', label: 'صورتحساب', icon: 'DollarSign', keywords: 'billing صورتحساب', category: 'مالی' },
  { to: '/panel/billing/report', label: 'گزارش مالی', icon: 'FileBarChart', keywords: 'financial report مالی', category: 'گزارش‌ها' },
  { to: '/panel/settlements', label: 'تسویه حساب', icon: 'DollarSign', keywords: 'settlement تسویه', category: 'مالی' },
  { to: '/panel/notifications', label: 'اعلانات', icon: 'Bell', keywords: 'notifications اعلان', category: 'مدیریت سیستم' },
  { to: '/panel/users', label: 'کاربران', icon: 'UserCircle', keywords: 'users کاربر', category: 'مدیریت سیستم' },
  { to: '/panel/backup', label: 'پشتیبان', icon: 'HardDrive', keywords: 'backup پشتیبان', category: 'مدیریت سیستم' },
  { to: '/panel/deleted-items', label: 'موارد حذف شده', icon: 'Archive', keywords: 'deleted حذف', category: 'مدیریت سیستم' },
  { to: '/panel/activity-log', label: 'لاگ‌ها', icon: 'Activity', keywords: 'log لاگ activity', category: 'مدیریت سیستم' },
  { to: '/panel/bulk-sms', label: 'ارسال پیامک گروهی', icon: 'Send', keywords: 'bulk sms گروهی', category: 'مدیریت سیستم' },
  { to: '/panel/sms-templates', label: 'قالب‌های پیامک', icon: 'MessageSquare', keywords: 'sms template قالب', category: 'مدیریت سیستم' },
  { to: '/panel/sms-history', label: 'تاریخچه پیامک‌ها', icon: 'History', keywords: 'sms history تاریخچه', category: 'مدیریت سیستم' },
  { to: '/panel/settings', label: 'تنظیمات', icon: 'Settings', keywords: 'settings تنظیمات', category: 'مدیریت سیستم' },
  { to: '/panel/deleted-items', label: 'موارد حذف شده', icon: 'Archive', keywords: 'deleted حذف', category: 'مدیریت سیستم' },
]

const categories = ['همه', 'صفحات اصلی', 'نوبت‌ها', 'پزشکی', 'مالی', 'گزارش‌ها', 'کلینیک', 'مدیریت سیستم', 'بیماران']
...
export default function CommandPalette({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const allItems: AllItem[] = [
    ...
    ...patients.map(p => ({ _type: 'patient' as const, to: `/panel/patients/${p.id}`, label: `${p.first_name} ${p.last_name}`, sub: p.phone || p.national_id || '', icon: 'Users', category: 'بیماران' })),
  ]
