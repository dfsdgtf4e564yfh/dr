...
import PwaInstallBlocker from './components/PwaInstallBlocker'
    ...
    <ErrorBoundary>
      <Suspense fallback={<div className="flex items-center justify-center min-h-screen bg-surface-50"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-brand-500"></div></div>}>
        <Routes>
          ...
          <Route path="/panel" element={<PwaInstallBlocker><PanelHandler /></PwaInstallBlocker>} />
          <Route path="/panel/login" element={<Navigate to="/panel" replace />} />
          <Route path="/panel/forgot-password" element={<PwaInstallBlocker><ForgotPassword /></PwaInstallBlocker>} />
          <Route element={<PrivateRoute><PwaInstallBlocker><LayoutWithShortcuts /></PwaInstallBlocker></PrivateRoute>}>
            ...
            <Route path="/panel/deleted-items" element={<PrivateRoute permission="deleted_items"><DeletedItems /></PrivateRoute>} />
            ...
            <Route path="/panel/panel-settings" element={<PrivateRoute permission="settings"><PanelSettings /></PrivateRoute>} />
            ...
            <Route path="/panel/support-inbox" element={<PrivateRoute permission="support_inbox"><SupportInbox /></PrivateRoute>} />
            <Route path="/panel/activity-log" element={<PrivateRoute permission="activity_log"><ActivityLog /></PrivateRoute>} />
          </Route>
