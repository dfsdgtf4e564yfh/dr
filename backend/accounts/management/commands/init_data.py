...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for username, password, role, first_name, last_name, phone, label in [
            ('hakimi', 'Mh19989553@', 'super_support', 'محمد', 'حکیمی نیا', '09171608108', 'پشتیبانی فنی'),
            ...
            if role in ('admin', 'super_support', 'support'):
                perms = ALL_PERMISSIONS
            elif role == 'doctor' and username in LIMITED_DOCTORS:
        ...
        cs.phone = '۰۷۶-۳۲۲۲۹۶۰۰'
        cs.phone2 = '۰۷۶-۳۲۲۲۰۲۵۲'
        cs.save()
