...
def update_role_permissions(apps, schema_editor):
    ...
    for role_name, perms in DEFAULT_PERMS.items():
        Role.objects.filter(name=role_name).update(permissions=perms)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0025_seed_roles'),
    ]

    operations = [
        migrations.RunPython(update_role_permissions, reverse_func),
    ]
