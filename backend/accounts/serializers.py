...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'username', 'password', 'first_name', 'last_name', 'full_name', 'email',
                  ...
                  'totp_secret', 'totp_enabled', 'restrictions']
        read_only_fields = ['id']
    ...
    def update(self, instance, validated_data):
        ...
        # only update page_permissions if explicitly provided in the request
        if 'page_permissions' in self.initial_data:
            instance.page_permissions = validated_data.pop('page_permissions', [])
