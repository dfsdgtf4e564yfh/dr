ALL_PAGES = [
    ...
    {'codename': 'doctor_treatments', 'name': 'ارتباط پزشک و بخش', 'group': 'مدیریت سیستم'},
    {'codename': 'doctor_treatments_create', 'name': 'ایجاد ارتباط پزشک و بخش', 'group': 'مدیریت سیستم'},
    {'codename': 'doctor_treatments_edit', 'name': 'ویرایش ارتباط پزشک و بخش', 'group': 'مدیریت سیستم'},
    {'codename': 'doctor_treatments_delete', 'name': 'حذف ارتباط پزشک و بخش', 'group': 'مدیریت سیستم'},
...
DEFAULT_ROLE_PERMISSIONS = {
    ...
    'psychologist': ['dashboard', 'dashboard_income', 'patients', 'patient_info',
     ...
     'rtms': ['dashboard', 'patients', 'patient_info',
              ...
              'appointments', 'appointment_create', 'appointment_edit', 'appointment_cancel', 'appointments_calendar', 'waiting_list',
