...
class GitHubBackupConfig(models.Model):
    ...
    token = models.CharField(max_length=255, blank=True, verbose_name='توکن دسترسی GitHub')
    oauth_token = models.TextField(blank=True, verbose_name='توکن OAuth گیت‌هاب')
    ...
    oauth_client_secret = models.CharField(max_length=255, blank=True, verbose_name='Client Secret اپ گیت‌هاب')
