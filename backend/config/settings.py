...
ALLOWED_HOSTS = ['*'] if _allowed_hosts_raw == '*' else [h.strip() for h in _allowed_hosts_raw.split(',') if h.strip()]
...
SQLITE_DIR = BASE_DIR.parent / 'public' / 'data'
...
BACKUP_DIR = os.environ.get('BACKUP_DIR', os.path.join(BASE_DIR.parent, 'public', 'backups'))
