...
class PatientViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        AuditLog.objects.create(
            ...
            details={'full_name': f"{patient.first_name} {patient.last_name}", 'national_id': patient.national_id}
        )
    ...
    def perform_destroy(self, instance):
        ...
        AuditLog.objects.create(
            ...
            details={'full_name': patient_name, 'national_id': instance.national_id}
        )
    ...
    def permanent_delete(self, request, pk=None):
        ...
        AuditLog.objects.create(
            ...
            model_name='Patient',
            object_id=pk,
            details={'full_name': name, 'national_id': patient.national_id}
        )
