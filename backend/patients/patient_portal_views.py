...
def portal_login(request):
    ...
    try:
        ...
        patient = Patient.objects.get(national_id_hash=nhash, phone_hash=phash, is_deleted=False)
...
def portal_verify_otp(request):
    ...
    try:
        nhash = hash_value(national_id)
        patient = Patient.objects.get(national_id_hash=nhash, is_deleted=False)
    except Patient.DoesNotExist:
        return Response(
