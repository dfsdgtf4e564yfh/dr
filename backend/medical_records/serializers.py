...
from .models import MedicalRecord, MedicalRecordFile, AuditLog, CommonDiagnosis, CommonDrug, CommonTreatmentPlan, TmsForm
...
class MedicalRecordSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'patient', 'patient_name', 'patient_national_id', 'patient_file_number',
                  ...
                  'treatment_plan', 'notes', 'prescription', 'files',
