...
class MedicalRecordSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['id', 'session_number', 'created_at', 'updated_at']
...
class AuditLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AuditLog
        fields = ['id', 'user', 'user_name', 'action', 'model_name', 'model',
                  'object_id', 'details', 'description', 'ip_address', 'timestamp', 'created_at']
