...
class TmsForm(BaseModel):
    ...
    score_u = models.FloatField(null=True, blank=True, verbose_name='U')
    score_y = models.FloatField(null=True, blank=True, verbose_name='Y')
    score_mt1 = models.FloatField(null=True, blank=True, verbose_name='Mt')
    score_mt2 = models.FloatField(null=True, blank=True, verbose_name='Mt')
    score_mt3 = models.FloatField(null=True, blank=True, verbose_name='Mt')
    score_mt4 = models.FloatField(null=True, blank=True, verbose_name='Mt')
