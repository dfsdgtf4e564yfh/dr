...
class TmsForm(BaseModel):
    ...
    score_c = models.FloatField(null=True, blank=True, verbose_name='C')
    score_ni = models.FloatField(null=True, blank=True, verbose_name='NI')
    score_tt = models.FloatField(null=True, blank=True, verbose_name='TT')
    score_x = models.FloatField(null=True, blank=True, verbose_name='X')
    score_y = models.FloatField(null=True, blank=True, verbose_name='Y')
    score_mt80 = models.FloatField(null=True, blank=True, verbose_name='Mt80')
    score_mt90 = models.FloatField(null=True, blank=True, verbose_name='Mt90')
    score_mt100 = models.FloatField(null=True, blank=True, verbose_name='Mt100')
    score_mt120 = models.FloatField(null=True, blank=True, verbose_name='Mt120')
    score_mt130 = models.FloatField(null=True, blank=True, verbose_name='Mt130')
