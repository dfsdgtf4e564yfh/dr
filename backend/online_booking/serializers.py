...
class PatientLookupSerializer(serializers.ModelSerializer):
    class Meta:
        model = Patient
        fields = ['id', 'first_name', 'last_name', 'national_id', 'phone', 'gender', 'birth_date', 'father_name', 'education', 'job', 'file_number']
...
class BookingRequestSerializer(serializers.Serializer):
    ...
    job = serializers.CharField(required=False, allow_blank=True, default='')
    address = serializers.CharField(required=False, allow_blank=True, default='')
    emergency_phone = serializers.CharField(required=False, allow_blank=True, default='')
